...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (saveBtn) {
        ...
        // On page load, set initial saved count in navbar
        const savedCountBadge = document.getElementById("savedCountBadge");
        if (savedCountBadge && savedCountBadge.innerText === '') {
            savedCountBadge.innerText = 0; // Set to 0 if not set
        }
        ...
        saveBtn.addEventListener("click", function () {
            ...
            fetch(toggleUrl, {
                ...
                .then(data => {
                    ...
                    if (saveCount) {
                        saveCount.innerText = data.total_saves; // Update the save count on the button
                    }
                    ...
                    if (badge) {
                        badge.innerText = data.total_saves > 0 ? data.total_saves : 0; // Always set to 0 if there are no saved recipes
                    }
                })
                .catch(err => {
