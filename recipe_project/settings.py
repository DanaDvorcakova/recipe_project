...
ALLOWED_HOSTS = ['https://recipe-project-2-gxqs.onrender.com', '127.0.0.1', os.getenv('RENDER_EXTERNAL_HOSTNAME', '')]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.most_liked_recipe',
                'blog.context_processors.saved_posts_count',
            ],
        },
    },
]
